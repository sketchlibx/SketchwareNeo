package neo.sketchware.activities.resourceseditor.components.utils;
...
import neo.sketchware.utility.XmlUtil;
            ...
            if (attrId != 0 && referencingLimit > 0) {
                ...
                if (isNightVariant) {
                    if (material3LibraryManager.isDynamicColorsEnabled()) {
                        themedContext = new ContextThemeWrapper(context, R.style.ThemeOverlay_SketchwareNeo_ViewEditor_Material3_Dark);
                    } else {
                        themedContext = new ContextThemeWrapper(context, R.style.ThemeOverlay_SketchwareNeo_ViewEditor_Material3_NON_DYNAMIC_Dark);
                    }
                } else {
                    if (material3LibraryManager.isDynamicColorsEnabled()) {
                        themedContext = new ContextThemeWrapper(context, R.style.ThemeOverlay_SketchwareNeo_ViewEditor_Material3_Light);
                    } else {
                        themedContext = new ContextThemeWrapper(context, R.style.ThemeOverlay_SketchwareNeo_ViewEditor_Material3_NON_DYNAMIC_Light);
                    }
                }
