    ...
    public void sendRequest(AiModelConfig config, String systemPrompt, String userPrompt, AiResponseCallback callback) {
        EXECUTOR.execute(() -> {
            try {
                ...
                String response = AiHttpUtil.post("https://api.openai.com/v1/chat/completions", headers, body.toString());
                ...
                postFailure(callback, e.getMessage() != null ? e.getMessage() : "OpenAI request failed");
            }
        });
    }
